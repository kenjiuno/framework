...
public class FocusElementPanel extends SimpleFocusablePanel {
    ...
    public void setAccessKey(char key) {
        Element accessKeyElement = null;
        if (BrowserInfo.get().isIE6()) {
            accessKeyElement = getElement();
        } else if (getFocusElement() != null) {
            accessKeyElement = getFocusElement();
        }
        if (accessKeyElement != null) {
            DOM.setElementProperty(accessKeyElement, "accessKey", "" + key);
        }
    }
