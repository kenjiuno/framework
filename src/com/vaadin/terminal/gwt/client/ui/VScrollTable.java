...
public class VScrollTable extends FlowPanel implements Table, ScrollHandler,
    ...
    public void updateFromUIDL(UIDL uidl, ApplicationConnection client) {
        ...
        /*
         * Fixing regression with #8584 caused by #13244. If the server has
         * (re)initialized the rows, our selectionRangeStart row will point to
         * an index that the server knows nothing about. To fix that we need to
         * update focusedRow and selectionRangeStart values.
         *
         * (#13244)
         */
        boolean isFocusedRowReset = uidl
                .hasAttribute(ATTRIBUTE_KEY_MAPPER_RESET)
                && uidl.getBooleanAttribute(ATTRIBUTE_KEY_MAPPER_RESET)
                && selectionRangeStart != null;
        if (focusedRow != null) {
            if (!focusedRow.isAttached()
                    && (!rowRequestHandler.isRunning() || isFocusedRowReset)) {
